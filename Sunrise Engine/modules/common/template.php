...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo($section['preview_image'] != "" ? $section['preview_image'] : "/modules/common/logo/og_logo.png");?>"/>
	...
	<meta property="og:image" content="<?php echo($section['preview_image'] != "" ? $section['preview_image'] : "/modules/common/logo/og_logo.png");?>"/>
	<meta property="og:type" content="website"/>
	
	<title><?php echo($section['title']);?></title>
	
	<link rel="stylesheet" href="/engine/assets/common.css" type="text/css" />
	<link rel="stylesheet" href="/modules/common/assets/site.css" type="text/css" />
	
	<link rel="shortcut icon" href="<?php echo($section['icon'] != "" ? $section['icon'] : "/modules/common/favicon.ico");?>" type="image/x-icon"/>
	
	<script type="text/javascript" src="/engine/libs/jquery.js"></script>
	
	<script type="text/javascript" src="/engine/js/common.js"></script>
	<script type="text/javascript" src="/modules/common/js/site.js"></script>
