...
<head>
    ...
    <meta name="msapplication-TileImage" content="<?php echo($section['preview_image'] != "" ? $section['preview_image'] : "/modules/wide_template/assets/logo/og_logo.png");?>"/>
	...
	<meta property="og:image" content="<?php echo($section['preview_image'] != "" ? $section['preview_image'] : "/modules/wide_template/assets/logo/og_logo.png");?>"/>
	<meta property="og:type" content="website"/>
	
	<title><?php echo($section['title']);?></title>
	
	<link rel="stylesheet" href="/engine/assets/common.css?1" type="text/css" />
	<link rel="stylesheet" href="/modules/wide_template/assets/site.css?1" type="text/css" />
	
	<link rel="shortcut icon" href="<?php echo($section['icon'] != "" ? $section['icon'] : "/modules/wide_template/favicon.ico");?>" type="image/x-icon"/>
	
	<script type="text/javascript" src="/engine/libs/jquery.js?1"></script>
	
	<script type="text/javascript" src="/engine/js/common.js?1"></script>
	<script type="text/javascript" src="/modules/wide_template/js/site.js?1"></script>
...
<body id='body'>
	...
	<div id='body_wrap'>
		<div id='scroll_top' class='scroll_top' style='display: <?php Draw(isTrue($section['layout'] != 3, "block", "none"));?>;' onclick='ScrollTo("scroll_top");'></div>
